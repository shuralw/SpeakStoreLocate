...
## Repository-Zweck
ASP.NET Core 10.0 Microservices-Architektur mit:
- API Service (C#/.NET)
- Angular Frontend
- Docker Containerisierung
- AWS App Runner Deployment
- Azure Container Apps für PR Previews
- Es handelt sich um ein Hobbyprojekt. Es muss keine kommerzielle Qualität haben, aber Best Practices sollten beachtet werden.

**Stack:** .NET 8.0, C#, Angular, Docker, AWS/Azure
